...
def hata (text):
   console.print(Panel(f'[bold blue]{text}[/]',width=80),justify="center")                         
def bilgi (text):
   console.print(Panel(f'[blue]{text}[/]',width=80),justify="center")                         
def basarili (text):
   console.print(Panel(f'[bold green] {text}[/]',width=80),justify="center")                         
def onemli (text):
   console.print(Panel(f'[bold cyan]{text}[/]',width=80),justify="center")                         
def soru (soru):
   console.print(Panel(f'[bold yellow]{soru}[/]',width=80),justify="center")                         
   return console.input(f"[bold yellow]>> [/]")
def logo (dil = "None"):
   surum = str(sys.version_info[0]) + "." + str(sys.version_info[1])
   console.print(Panel(f"[bold blue]@HerlockUserBot Installer 🇹🇷[/]\n\n[bold cyan]Version: [/][i]0.2[/]\n[bold cyan]Python: [/][i]{surum}[/]\n[bold cyan]Dil: [/][i]{dil}[/]",width=80),justify="center")                         
